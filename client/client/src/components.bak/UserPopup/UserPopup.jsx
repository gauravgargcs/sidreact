...
const UserStep = React.memo(({ onSettings, onLogout, onClose, user, setDarkUI, setLightUI, setNewDarkUI, setNewLightUI, mode  }) => {
      ...
      <Popup.Content>
          <ul className = 'user-menu'>
            ...
            <li>
              ...
              <span>Theme</span>
              <button onClick = {()=>handleThemeMenu()} type = 'button'>{(() => {
                switch (mode) {
                  case 'bg-light':
              ...
              })()}<i className="fas fa-sort-down"/></button>
              {userMenu &&
                <ul className = 'theme-menu'>
                  ...
                  <li><button type = 'button' onClick = {() => {
                    setNewLightUI();
                    handleThemeMenu();
                  }}>Light modeN</button></li>
                  <li><button type = 'button' onClick = {() => {
                    setNewDarkUI();
                    handleThemeMenu();
                  }}>Dark modeN</button></li>
                </ul>
                }
            </li>
            <li>

...
const Sidebar = React.memo(({ currentModal,onUsers, onUserSettings, onLogout, user, setDarkUI, setLightUI, setNewDarkUI, setNewLightUI, theme, sidebar, expand, collapse, history, location}) => {
